...
The [CrashUtils](https://universalextensions.com/extension/com.distriqt.CrashUtils) plugin gives
you access 
...
Open the Asset Store in your browser and add the CrashUtils plugin to your assets.

Open the Package Manager (Window > Package Manager) in the Unity Editor and select the "My Assets" section. Select the CrashUtils plugin, and click Import in the bottom right.
