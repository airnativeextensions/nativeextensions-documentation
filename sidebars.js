module.exports = {
	...
	applesignin: [
		...
		{
			Usage: ["applesignin/login-with-apple-id", "applesignin/get-user-credentials"],
		},
		{
			Other: [
	...
	application: [
		...
		{
			"Storing User Data": ["application/defaults", "application/keychain", "application/settings"],
		},
		{
	...
	applicationrater: [
		...
		{
			"Get Started": ["applicationrater/add-the-extension", "applicationrater/add-the-plugin"],
		},
		{
			Usage: [
	...
	audiorecorder: [
		...
		{
			"Get Started": ["audiorecorder/add-the-extension", "audiorecorder/requesting-authorisation"],
		},
		{
	...
	beacon: [
		...
		{
			"Get Started": ["beacon/add-the-extension", "beacon/requesting-authorisation"],
		},
		{
			Usage: ["beacon/monitoring-a-region", "beacon/broadcasting", "beacon/events", "beacon/tools-and-resources"],
		},
		{
			Other: [
	...
	bluetoothle: [
		...
		{
			"Get Started": ["bluetoothle/add-the-extension", "bluetoothle/request-authorisation"],
		},
		{
			Usage: [
	...
	calendar: [
		...
		{
			"Get Started": ["calendar/add-the-extension", "calendar/request-authorisation"],
		},
		{
	...
	camera: [
		...
		{
			"Get Started": ["camera/add-the-extension", "camera/requesting-authorisation"],
		},
		{
			Usage: [
	...
	camerarollextended: [
		...
		{
			"Get Started": ["camerarollextended/add-the-extension", "camerarollextended/request-authorisation"],
		},
		{
			Usage: [
	...
	cameraui: [
		...
		{
			"Get Started": ["cameraui/add-the-extension", "cameraui/requesting-authorisation"],
		},
		{
	...
	cloudstorage: [
		...
		{
			"Get Started": ["cloudstorage/add-the-extension", "cloudstorage/add-the-plugin"],
		},
		{
			Usage: ["cloudstorage/key-value-storage", "cloudstorage/document-store", "cloudstorage/android-testing"],
		},
		{
			Other: [
	...
	contacts: [
		...
		{
			"Get Started": ["contacts/add-the-extension", "contacts/request-authorisation"],
		},
		{
			"Access the Contact List": ["contacts/retrieving-the-contact-list", "contacts/contact-images"],
		},
		{
	...
	devicemotion: [
		...
		{
			Usage: ["devicemotion/register-for-updates", "devicemotion/algorithms-and-format"],
		},
		{
			Other: [
	...
	dialog: [
		...
		{
			"Get Started": ["dialog/add-the-extension", "dialog/dialog-views-and-builders"],
		},
		{
			Usage: [
				"dialog/toast",
	...
	dynamicicon: [
		...
		{
			"Get Started": ["dynamicicon/add-the-extension", "dynamicicon/adding-icons", "dynamicicon/packaging"],
		},
		{
	...
	expansionfiles: [
		...
		{
			"Get Started": ["expansionfiles/add-the-extension", "expansionfiles/request-authorisation"],
		},
		{
	...
	"facebookapi-legacy": [
		...
		{
			"App Links": ["facebookapi-legacy/app-links---overview", "facebookapi-legacy/app-links---incoming-links"],
		},
		{
			Games: ["facebookapi-legacy/games---overview", "facebookapi-legacy/games---game-request-dialog"],
		},
		{
			"Graph API": [
	...
	firebase: [
			...
			items: [
				...
				},
				{
					"Realtime Database": [
						...
						{
							Offline: ["firebase/database/offline", "firebase/database/disconnect"],
						},
					],
				},
				{
		...
		{
			"Migration Guides": ["firebase/migrating-to-v6", "firebase/migrating-to-v4"],
		},
		{
			Other: [
				{
	...
	flurry: [
		...
		{
			"Get Started": ["flurry/add-the-extension", "flurry/initialise-the-extension"],
		},
		{
			Analytics: [
	...
	gameservices: [
		...
		{
			"Setup Services": ["gameservices/setup-gamecenter", "gameservices/setup-google-play-games"],
		},
		{
			Integration: [
		...
		},
		{
			Usage: [
				...
				{
					"Saved Games": ["gameservices/saved-games", "gameservices/saved-games---conflicts"],
				},
				{
				...
				{
					"User Interface": ["gameservices/user-interface", "gameservices/access-point"],
				},
			],
		},
		{
			Help: ["gameservices/troubleshooting", "gameservices/migrating-to-androidx"],
		},
		{
			Other: [
	...
	googleanalytics: [
		...
		{
			"Setup the Extension": ["googleanalytics/add-the-extension", "googleanalytics/tracking-ids"],
		},
		{
			Usage: [
	...
	inappbilling: [
		...
		},
		{
			...
			items: [
				...
				{
					"Subscription Discounts and Offers": ["inappbilling/discounts", "inappbilling/introductory-prices"],
				},
	...
	location: [
		...
		{
			"Get Started": ["location/add-the-extension", "location/initialise-the-extension"],
		},
		{
			Usage: [
	...
	mediaplayer: [
		...
		{
			"Audio Player": ["mediaplayer/audio-player", "mediaplayer/audio-player---background-audio"],
		},
		{
			"Sound Pool": ["mediaplayer/sound-pool"],
		},
		{
			"System Integration": ["mediaplayer/remote-command-center", "mediaplayer/system-control"],
		},
		{
			Troubleshooting: ["mediaplayer/migrating-to-androidx", "mediaplayer/migrating-from-version-1"],
		},
		{
			Other: [
	...
	nativemaps: [
		...
		{
			"Setup your mapping provider": ["nativemaps/apple-maps", "nativemaps/google-maps"],
		},
		{
			"Setup the Extension": [
	...
	nativewebview: [
		...
		{
			"Get Started": ["nativewebview/add-the-extension", "nativewebview/initialise-the-extension"],
		},
		{
			"Web View": [
		...
		{
			Troubleshooting: ["nativewebview/migrating-to-androidx", "nativewebview/migrating-to-v5"],
		},
		{
			Other: [
	...
	permissions: [
		...
		{
			Usage: ["permissions/set-permissions", "permissions/requesting-access", "permissions/system-settings"],
		},
		{
	...
	scanner: [
		...
		{
			Usage: ["scanner/requesting-access", "scanner/scanning", "scanner/scanning-bitmap-data"],
		},
		{
			Troubleshooting: ["scanner/migrating-to-version-5", "scanner/migrating-to-androidx"],
		},
		{
			Other: [
	...
	share: [
		...
		{
			Troubleshooting: ["share/migrating-from-message", "share/migrating-to-androidx"],
		},
		{
			Other: [
	...
	vibration: [
		...
		{
			"Get Started": ["vibration/add-the-extension", "vibration/add-the-plugin"],
		},
		{
			Usage: ["vibration/vibrate", "vibration/feedback-generators", "vibration/haptic-engine"],
		},
		{
			Other: [
	...
	volume: [
		...
		{
			Usage: ["volume/volume-control", "volume/streams", "volume/silent-switch"],
		},
		{
			Other: [
	...
	webp: [
		...
		{
			Usage: ["webp/webploader", "webp/load-a-webp-file", "webp/parse-webp-data"],
		},
		{
			Other: [
	...
	tutorials: [
		...
		{
			Debugging: ["tutorials/device-logs", "tutorials/android-device-debugging"],
		},
		{
			"iOS Development": [
