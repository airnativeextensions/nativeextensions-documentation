...
v6.1 brings an updated process for requesting permissions on Android. 
...
```xml
<activity android:name="com.distriqt.extension.camera.permissions.AuthorisationActivity" android:theme="@android:style/Theme.Translucent.NoTitleBar" android:exported="false" />
```
