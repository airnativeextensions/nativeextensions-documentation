...
The `com.distriqt.applovinsdk.AdMob` ANE includes the AppLovin AdMob mediation adapter. This is everything you need to get AdMob mediation working in your application.

To add the ANE download it from the repository and add it to your application:

- [com.distriqt.applovinsdk.AdMob](https://github.com/distriqt/ANE-AppLovinSDK/raw/master/lib/admob/com.distriqt.applovinsdk.AdMob.ane)
