...
```
apm install com.distriqt.InAppBilling-Catappult
```
...
| | |____ ...
|____ ane
| |____ com.distriqt.InAppBilling.Catappult.ane	    # InAppBilling Catappult extension
| |____ [dependencies]
...
- You will have an `assets` directory that contains required assets for the installed extensions. You must add the files in the `assets/android` folder to the root of your Android application package. You do not need to add this to your iOS application package.
