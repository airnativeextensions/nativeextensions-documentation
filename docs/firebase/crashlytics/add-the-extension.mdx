...
On Android you will need to add a unique "build_id" to the `values.xml` resources file you created for your project Firebase configuration.
Generate a random UUID and add the following line to the `values.xml` with your UUID:
