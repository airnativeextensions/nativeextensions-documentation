---
title: Migrating to v3.5
sidebar_label: Migrating to v3.5
---

import Tabs from '@theme/Tabs'
import TabItem from '@theme/TabItem'

v3.5 brings an updated process for requesting permissions on Android. 
...
```xml
<activity android:name="com.distriqt.extension.cameraui.permissions.AuthorisationActivity" android:theme="@android:style/Theme.Translucent.NoTitleBar" android:exported="false" />
```
