...
To add the extension to your development environment. Download the `com.distriqt.InAppBilling.Amazon.ane` extension from the repository and then follow the tutorial located [here](/docs/tutorials/getting-started) to add the extension to your development environment.
