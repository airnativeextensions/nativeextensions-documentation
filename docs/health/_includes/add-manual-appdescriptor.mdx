...
In addition to the above you will need to add the permissions for the health data you require access to, for example, to read and write the step data you need the following permissions:
