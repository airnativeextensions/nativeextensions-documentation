...
You will likely want to update your application to use the latest target sdk version to ensure compatibility with the latest Google Play requirements. At the time of publishing this update, the latest target sdk version is 35.
