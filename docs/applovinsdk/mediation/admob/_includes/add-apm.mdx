...
```
apm install com.distriqt.applovinsdk.AdMob
```
...
.
|____ ane
| |____ com.distriqt.applovinsdk.AdMob.ane	# AdMob mediation extension
| |____ [dependencies]
...
- You will need to set the AdMob application identifier values for your application. Call the following to step through the configuration values for this extension:

```
apm project config set com.distriqt.applovinsdk.AdMob
```
