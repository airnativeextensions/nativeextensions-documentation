...
The container identifier should be the container you created in [Setup Game Center](../setup.md#saved-games) and the kvstore identifier should be your iOS team id followed by your application (bundle) id.  
