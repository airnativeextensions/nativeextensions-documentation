...
- You must set the android and iOS Admob application identifiers you setup in the Admob console. This will allow `apm` to automatically insert them into the correct position in your application descriptor. Call the following to step through the configuration values for this extension:
