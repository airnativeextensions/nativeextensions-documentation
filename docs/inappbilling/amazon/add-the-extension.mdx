...
- Log into the [Developer Console](https://developer.amazon.com/) with your developer account.
- Go to Apps & Services > My Apps. Then click your app.
- Go to the [App Information](https://developer.amazon.com/docs/app-submission/app-information.html) tab.
