...
```xml
<extensions>
    <extensionID>com.distriqt.applovinsdk.IronSource</extensionID>
...
<manifest android:installLocation="auto" >
  ...
  <application android:appComponentFactory="androidx.core.app.CoreComponentFactory">
    ...
    <provider android:name="com.ironsource.lifecycle.IronsourceLifecycleProvider" android:authorities="APPLICATION_PACKAGE.IronsourceLifecycleProvider"/>
  </application>
</manifest>
```
