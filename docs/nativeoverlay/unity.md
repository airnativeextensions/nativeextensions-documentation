...
The [NativeOverlay](https://universalextensions.com/extension/com.distriqt.NativeOverlay) plugin gives
you access 
...
Open the Asset Store in your browser and add the NativeOverlay plugin to your assets.

Open the Package Manager (Window > Package Manager) in the Unity Editor and select the "My Assets" section. Select the NativeOverlay plugin, and click Import in the bottom right.


### Manual Installation

In unity you import the package by selecting `Assets / Import Package / Custom Package ...` and then browsing to the unity plugin package file: `com.distriqt.NativeOverlay.unitypackage`.

![](images/unity-import-package.png)

You can manually download the extension from our repository:

- https://github.com/distriqt/ANE-NativeOverlay
...
The `mainNativeOverlay.gradle` is generated when you enable the **Custom Gradle NativeOverlay** property on the Player window.
...
Update the `dependencies` section in your `mainNativeOverlay.gradle` or `build.gradle` as below:
