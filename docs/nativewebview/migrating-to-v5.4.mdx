---
title: Migrating to v5.4
sidebar_label: Migrating to v5.4
---
...
```xml
<activity android:name="com.distriqt.extension.nativewebview.permissions.AuthorisationActivity" android:theme="@android:style/Theme.Translucent.NoTitleBar" android:exported="false" />
```
