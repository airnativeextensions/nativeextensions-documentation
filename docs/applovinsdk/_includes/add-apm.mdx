...
```
apm install com.distriqt.AppLovinSDK
```
...
.
|____ ane
| |____ com.distriqt.AppLovinSDK.ane	# AppLovinSDK extension
| |____ [dependencies]
...
- You will need to set the AppLovin SDK Key for your application. Call the following to step through the configuration values for this extension:

```
apm project config set com.distriqt.AppLovinSDK
```
