---
title: Windows Push Notification Services
...
You should firstly setup WNS for your application. See the [setup](windows-notification-service) documentation to guide you through this process.
