...
The `com.distriqt.applovinsdk.IronSource` ANE includes the AppLovin IronSource mediation adapter. 
This is everything you need to get IronSource mediation working in your application.

To add the ANE download it from the repository and add it to your application:

- [com.distriqt.applovinsdk.IronSource](https://github.com/distriqt/ANE-AppLovinSDK/raw/master/lib/admob/com.distriqt.applovinsdk.IronSource.ane)
