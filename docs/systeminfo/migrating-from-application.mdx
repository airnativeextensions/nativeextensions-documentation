...
This guide assumes you are only using the system-related features of the Application extension. 

If you are using the Application extension for display related features, consider implementing the [Display](/docs/display) extension. 

If you are using the Application extension for storing user data, consider implementing the [AppGroupDefaults](/docs/appgroupdefaults) extension.
