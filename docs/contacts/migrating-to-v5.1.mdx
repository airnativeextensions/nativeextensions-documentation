---
title: Migrating to v5.1
sidebar_label: Migrating to v5.1
---

import Tabs from '@theme/Tabs'
import TabItem from '@theme/TabItem'

v5.1 brings an updated process for requesting permissions on Android. 
...
```xml
<activity android:name="com.distriqt.extension.contacts.permissions.AuthorisationActivity" android:theme="@android:style/Theme.Translucent.NoTitleBar" android:exported="false" />
```
