...
The `com.distriqt.admob.Vungle` ANE includes the Vungle SDK and the AdMob Vungle mediation adapter. This is everything you need to get Vungle mediation working in your application.

To add the ANE download it from the repository and add it to your application:

- [`com.distriqt.admob.Vungle`](https://github.com/distriqt/ANE-Adverts-Mediation/raw/master/lib/applovin/com.distriqt.admob.Vungle.ane)
