...
import SetupAPM from '../../_includes/apm/setup-apm.md'
<SetupAPM />
...
```
apm install com.distriqt.GoogleAnalytics
```
...
.
|____ ane
| |____ com.distriqt.GoogleAnalytics.ane	# GoogleAnalytics extension
| |____ [dependencies]
