---
title: Migrating to v6.12
sidebar_label: Migrating to v6.12
---

import Tabs from '@theme/Tabs'
import TabItem from '@theme/TabItem'

v6.12 brings an updated process for requesting permissions on Android. 
...
```xml
<activity 
  android:name="com.distriqt.extension.application.permissions.AuthorisationActivity" 
