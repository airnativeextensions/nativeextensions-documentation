...
The `com.distriqt.applovinsdk.Facebook` ANE includes the AppLovin Facebook mediation adapter.
This is everything you need to get Facebook mediation working in your application.

To add the ANE download it from the repository and add it to your application:

- [com.distriqt.applovinsdk.Facebook](https://github.com/distriqt/ANE-AppLovinSDK/raw/master/lib/admob/com.distriqt.applovinsdk.Facebook.ane)
