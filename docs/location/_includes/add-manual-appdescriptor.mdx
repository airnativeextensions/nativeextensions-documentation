...
<manifest android:installLocation="auto">
	...
	<application>
        ...
        <receiver android:name="com.distriqt.extension.location.receivers.LocationReceiver" android:exported="true" >
            <intent-filter>
        ...
        <service android:name="com.distriqt.extension.location.services.GeofenceRestartService" android:exported="true" />
