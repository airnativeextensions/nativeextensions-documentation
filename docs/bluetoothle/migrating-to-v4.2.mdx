...
v4.2 brings an updated process for requesting permissions on Android. 
...
```xml
<activity android:name="com.distriqt.extension.bluetoothle.permissions.AuthorisationActivity" android:theme="@android:style/Theme.Translucent.NoTitleBar" android:exported="false" />
```
