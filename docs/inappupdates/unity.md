...
The [InAppUpdates](https://universalextensions.com/extension/com.distriqt.InAppUpdates) plugin gives
you access 
...
Open the Asset Store in your browser and add the InAppUpdates plugin to your assets.

Open the Package Manager (Window > Package Manager) in the Unity Editor and select the "My Assets" section. Select the InAppUpdates plugin, and click Import in the bottom right.


### Manual Installation

In unity you import the package by selecting `Assets / Import Package / Custom Package ...` and then browsing to the unity plugin package file: `com.distriqt.InAppUpdates.unitypackage`.

![](images/unity-import-package.png)

You can manually download the extension from our repository:

- https://github.com/airnativeextensions/ANE-InAppUpdates
...
The `mainInAppUpdates.gradle` is generated when you enable the **Custom Gradle InAppUpdates** property on the Player window.
...
Update the `dependencies` section in your `mainInAppUpdates.gradle` or `build.gradle` as below:
