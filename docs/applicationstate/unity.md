...
The [ApplicationState](https://universalextensions.com/extension/com.distriqt.ApplicationState) plugin gives
you access 
...
Open the Asset Store in your browser and add the ApplicationState plugin to your assets.

Open the Package Manager (Window > Package Manager) in the Unity Editor and select the "My Assets" section. Select the ApplicationState plugin, and click Import in the bottom right.
