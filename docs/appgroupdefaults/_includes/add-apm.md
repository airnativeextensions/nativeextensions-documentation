...
- You will need to set the application group for iOS and Android in order that the application descriptor can be generated correctly for your application. Call the following to step through the configuration values for this extension:
